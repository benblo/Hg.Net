...
namespace Mercurial.Net
{
    ...
    /// instance of <see cref="System.IAsyncResult"/>, and being generic to be
    ...
    internal class AsyncResult<T> : IAsyncResult<T>
    {
        ...
        /// The inner <see cref="System.IAsyncResult"/> object to wrap.
        /// </param>
        ...
        /// </summary>
        /// <returns>
        /// A <see cref="System.Threading.WaitHandle"/> that is used to wait for an asynchronous operation to complete.
        /// </returns>
